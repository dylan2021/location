...
public class AsyncDrawable extends Drawable {
    ...
    private final WeakReference<ImageImpl.ImageLoaderCallback> imageLoaderCallbackReference;

    private Drawable baseDrawable;

    public AsyncDrawable(Drawable drawable, ImageImpl.ImageLoaderCallback bitmapWorkerTask) {
        if (bitmapWorkerTask == null) {
            throw new IllegalArgumentException("bitmapWorkerTask may not be null");
        }
        baseDrawable = drawable;
        imageLoaderCallbackReference = new WeakReference<ImageImpl.ImageLoaderCallback>(bitmapWorkerTask);
    }

    public ImageImpl.ImageLoaderCallback getImageLoaderCallback() {
        return imageLoaderCallbackReference.get();
    }
