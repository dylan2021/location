...
//  public abstract void removeOverlay(GLOverlayDecode paramu); // a
  ...
  public abstract void setMinZoomLevel(float minZoomLevel);
  ...
  public abstract void setMapType(int paramInt) //b
    throws RemoteException;
  
  public abstract boolean isTrafficEnabled() //w
    throws RemoteException;

  public abstract boolean isCellZonesEnabled() //w
    throws RemoteException;
  
  public abstract void setTrafficEnabled(boolean paramBoolean) //h
    throws RemoteException;

  public abstract void setParameter(String method, boolean paramBoolean) //h
    throws RemoteException;
...
//    throws RemoteException;
  ...
  public abstract void setMyLocationType(int paramInt) // a
    throws RemoteException;

  public abstract void setCustomType()
          throws RemoteException;
...
//  public abstract void getMapPrintScreen(MapController.onMapPrintScreenListener printScreenListener); // a
  ...
  public abstract boolean mapLoadMessageSent(); //R
  ...
  public abstract void setMapStyleIconForPath(String stylePath,String iconPath);

  public abstract void setMapStyleType(int mapStyleType);

  public abstract void setGridUrlListener(MapController.GridUrlListener listener);

  public abstract boolean getNeedToCenter();

  public abstract void setNeedToCenter(boolean isNeedToCenter);

  public abstract boolean isPOIByPoint(Point point);
