...
{
    private String TAG = NormalMapLoader.class.getSimpleName();
...
//        }
    ...
    if (this.datasource == DATA_SOURCE_TYPE_DATA_VEC_TMC) {//原始值为4
      ...
      return "t="+ Util.TMC_PARAMETER + "&v=6.0.0&bver=2&mesh=" + str3;
    }
  ...
  void processRecivedTileDataVTmc(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if (localf != null) {
//      this.mapCore.putMapData(arrayOfByte, 0, arrayOfByte.length, this.datasource, localf.createTime);
