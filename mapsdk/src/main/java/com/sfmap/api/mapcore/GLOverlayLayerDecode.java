...
class GLOverlayLayerDecode
{
  ...
  private Runnable g = new Runnable(){ //g
  ...
  public synchronized void clear(String paramString)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      Log.d("MapSDK", "GLOverlayLayer clear erro" + localThrowable.getMessage());
    }
  }
  
  public synchronized void destory() // a
  {
    try
    {
      for (IOverlayDelegateDecode localai : this.overlayList)
    ...
    {
      SDKLogHandler.exception(localThrowable, "GLOverlayLayer", "destory");
      localThrowable.printStackTrace();
      Log.d("MapSDK", "GLOverlayLayer destory erro" + localThrowable.getMessage());
    }
  }
  
  private synchronized IOverlayDelegateDecode d(String paramString) // d
  ...
  public synchronized boolean removeOverlay(String paramString) //c
    throws RemoteException
  {
    IOverlayDelegateDecode localai = d(paramString);
    if (localai != null) {
  ...
  protected synchronized void b() //b
  {
  ...
  public void a(Integer texsureId) // a
  {
...
//    mapState.getPixel20Bound(bound);
          ...
          implements Comparator<Object>, Serializable
  {
    public int compare(Object paramObject1, Object paramObject2)
    {
      ...
      {
        SDKLogHandler.exception(localThrowable, "GLOverlayLayer", "compare");
        localThrowable.printStackTrace();
      }
      return 0;
    }
