...
public class AppInfo {
    ...
    private static String searchDetailDefURL = "https://gis.sf-express.com/mms/search/detail";

    //搜索提示服务地址
    private static String searchSugURL = "";
    private static String searchSugDefURL = "https://gis.sf-express.com/mms/sug";
