...
public class URIBuilder {
	...
	public String removeParam(String name) {
		...
		if (queryParams != null && queryParams.size() > 0) {
			for (Iterator<NameValuePair> iter = queryParams.iterator(); iter.hasNext();) {
				NameValuePair item = iter.next();
     ...
     * @param charsetStr
     */
    public URI build(String charsetStr) throws URISyntaxException {
        return new URI(buildString(charsetStr));
    }

    public String buildString(String charsetStr) {
