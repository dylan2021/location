...
public class LruMemoryCache<K, V> {
     ...
     * value: expiry time
     */
    protected KeyExpiryMap<K, Long> keyExpiryMap;
    ...
    protected void removeLike(K key) {
    }
    ...
    public synchronized final String toString() {
        ...
        synchronized (this) {
            String result = String.format(Locale.getDefault(),
                "LruMemoryCache[maxSize=%d,size=%d,item=%d,hits=%d,misses=%d,hitRate=%d%%]============",
                maxSize, size, map.size(), hitCount, missCount, hitPercent);
            for (Map.Entry<K, V> kv : map.entrySet()) {
                result += "\n[" + safeSizeOf(kv.getKey(), kv.getValue()) + "] " + kv.getKey().toString();
            }
            return result;
        }
    }
