...
//        implements SfMapLocationListener
{
    ...
    //算路起点坐标
    protected NaviLatLng mStartLatlng = new NaviLatLng(22.983875, 113.71945);
    //算路起点坐标
...
//    private LocationManager locationManager;
    ...
    private TtsManager sfSpeechSyntesizer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sfSpeechSyntesizer = TtsManager.getInstance(NaviActivityDemo.this);
        initNaviData();
...
//            mSfMapLocationClient.destroy();
            ...
            Log.e(TAG, "NaviActivityDemo.onDestroy() error", e);
        }
    }
