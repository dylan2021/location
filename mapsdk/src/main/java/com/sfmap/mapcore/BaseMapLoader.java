...
//                    meshes = "132120030310";
//                    Log.d(TAG,"doRequest tmc meshes:" + meshes);
...
//                    tmcBean.setAppPackageName("com.hbfec.jczapp");
//                    tmcBean.setAppCerSha1("EF:D6:D9:9B:DE:F2:D8:E9:1B:77:2B:42:DD:BD:F6:A0:14:B6:C5:08");
//                    String ak ="ebf48ecaa1fd436fa3d40c4600aa051f";
...
//                    url = AppInfo.getSfTmcURL(mapCore.getContext()) +"?mesh=" + meshes;
                    Log.d(TAG,"doRequest tmc url:" + url);
                }
                else {
...
//
//
//                    mobileBean.setAppPackageName("com.unistrong.onguard");
//                    mobileBean.setAppCerSha1("A7:3A:EC:37:5D:DE:76:BD:E9:36:C1:77:63:07:E0:E9:9D:04:4C:4A");
//                    String ak ="e6713376ef2e4595982639578c55984a";
...
//        processRecivedDataByType();
    ...
    void processRecivedTileData(byte[] paramArrayOfByte, int paramInt1, int paramInt2) {
        Log.d(TAG,"processRecivedTileData");
        int i = paramInt1;
