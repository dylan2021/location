...
import com.sfmap.mapcore.BaseMapCallImplement;
...
import com.sfmap.mapcore.MapSourceGridData;
...
class MapCallback//a
    ...
    private final MapDelegateImp mapDelegate;
    ...
    @Override
    public void OnMapSurfaceRenderer(GL10 gl10, MapCore mapCore, int eventId) {
        super.OnMapSurfaceRenderer(gl10, mapCore, eventId);
        if (eventId == mapDelegate.drawCustomRenderEventId) {
            try{
        ...
        if(eventId == MapDelegateImp.DATA_AVAILABLE_EVENT_ID) {
    ...
    void runMessage(MapCore paramMapCore) {
        ...
        while ((mapMessage = this.mapDelegate.mMapMessges.getMessage()) != null) {
            try {
                ...
                SDKLogHandler.exception(localRemoteException1, "MapCallback", "runMessage");
        ...
        try {
            ...
            if (isCameraChangeFinish) {
                if (isCameraChangeFinish) {
                    this.mapDelegate.m(true);
                } else {
                    this.mapDelegate.m(false);
                }
    ...
    public void OnMapReferencechanged(MapCore mapCore, String paramString1, String paramString2) {
        try {
            ...
            SDKLogHandler.exception(localRemoteException, "MapCallback", "OnMapReferencechanged");
...
//            this.mapView.a(localf);
            ...
            SDKLogHandler.exception(localThrowable, "MapCallback", "onIndoorBuildingActivity");
        }
    }
