...
import static com.sfmap.route.util.AnimatorProxy.NEEDS_PROXY;
import static com.sfmap.route.util.AnimatorProxy.wrap;
...
public final class ViewHelper {
    ...
    public static float getRotation(View view) {
        return NEEDS_PROXY ? wrap(view).getRotation() : Honeycomb
                .getRotation(view);
    }
    ...
    public static float getRotationX(View view) {
        return NEEDS_PROXY ? wrap(view).getRotationX() : Honeycomb
                .getRotationX(view);
    }
    ...
    public static float getRotationY(View view) {
        return NEEDS_PROXY ? wrap(view).getRotationY() : Honeycomb
                .getRotationY(view);
    }
    ...
    public static float getScrollX(View view) {
        return NEEDS_PROXY ? wrap(view).getScrollX() : Honeycomb
                .getScrollX(view);
    }
    ...
    public static float getScrollY(View view) {
        return NEEDS_PROXY ? wrap(view).getScrollY() : Honeycomb
                .getScrollY(view);
    }
    ...
    public static float getTranslationX(View view) {
        return NEEDS_PROXY ? wrap(view).getTranslationX() : Honeycomb
    ...
    public static float getTranslationY(View view) {
        return NEEDS_PROXY ? wrap(view).getTranslationY() : Honeycomb
